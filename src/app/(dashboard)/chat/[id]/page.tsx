...
const mockInitialMessages: UIMessage[] = [
  {
    id: "mock-user-1",
    role: "user",
    parts: [
...
export default function Chat() {
  ...
  return (
    <section className="relative h-screen flex flex-col">
                  ...
                  if (part.type === "text") {
                    if (isUser) {
                      return (
                        <div
                          key={index}
                          className="max-w-xl bg-muted px-5 py-3 rounded-2xl whitespace-pre-wrap"
                        >
                          {part.text}
                        </div>
                      );
                          ...
                          <ReactMarkdown
                            ...
                            components={{
                              ...
                              code({
                                ...
                                // Pass through raw children for KaTeX so it
                                // can style the math itself.
                                if (isMath) {
                                  return (
                                ...
                                // Fenced block with NO language -> still a
                                // block, just without highlighting. Previously
                                // this fell through to the inline-code
                                // styling, which is why it looked broken.
                                if (!inline && !match) {
                                  return (
                                    <code
      ...
      <div className="max-w-2xl mx-auto w-full mb-4 p-4 border-t border-gray-200 bg-white">
        <form
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          <input
            ...
            className="flex-1 px-4 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-50"
          />
          ...
          {status === "streaming" || status === "submitted" ? (
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Send
            </button>
          )}
